...
class CheckinsControllerTest < ActionController::TestCase
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post :create, checkin: { clubs_id: @checkin.clubs_id, title: @checkin.title, users_id: @checkin.users_id }
    end
  ...
  test "should update checkin" do
    patch :update, id: @checkin, checkin: { clubs_id: @checkin.clubs_id, title: @checkin.title, users_id: @checkin.users_id }
    assert_redirected_to checkin_path(assigns(:checkin))
  end
